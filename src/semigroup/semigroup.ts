...
// getFirstSemigroup
const first = fromFoldable(
  ordString,
  getFirstSemigroup<User>(),
  array,
...
const ordInventoryRecord = contramap((inventoryRecord: InventoryRecord): [
  number,
  string,
] => [inventoryRecord.key, inventoryRecord.val.name])(
...
const isInBetween20And30 = semigroupPredicate.concat(isMoreThan20, isLessThan30)
